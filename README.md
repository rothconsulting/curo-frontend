...
## Continuous Integration 🔄 [![Circle Build Status](https://img.shields.io/circleci/build/github/umb/Curo?logo=CircleCi)](https://)

We use [CircleCi](https://circleci.com) for continuous integration. Check out our [Circle CI Status](https://).
...
* **Nikola Stanković** - *Initial work* - [rhea-0b1](https://github.com/rhea-0b1)

See also the list of [contributors](https://github.com/umb/Curo/contributors) who participated in this project. 💕
