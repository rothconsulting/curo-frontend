...
class DefaultFlowToNextService(
    private val properties: CuroProperties,
    private val taskService: TaskService,
    private val historyService: HistoryService
) : FlowToNextService {

    override fun getNextTask(lastTask: Task, timeout: Int): FlowToNextResult {
        return getNextTask(lastTask.processInstanceId, lastTask.assignee, timeout)
    }

    override fun getNextTask(lastTask: Task, assignee: String?, timeout: Int): FlowToNextResult {
        return getNextTask(lastTask.processInstanceId, assignee, timeout)
    }

    override fun getNextTask(processInstanceId: String, assignee: String?, timeout: Int): FlowToNextResult {
